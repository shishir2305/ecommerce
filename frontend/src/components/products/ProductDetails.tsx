    ...
    <div className="p-6">
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
        <div className="flex flex-col md:flex-row">
          ...
          {/* Mobile thumbnail */}
          <div className="md:hidden flex overscroll-x-auto space-x-2 mb-4">
            {selectedProduct.images.map((image, index) => (
              <img
                key={index}
                src={image.url}
          ...
          <div className="md:w-1/2 md:ml-10">
            ...
            <button
              ...
              className={`bg-black text-white py-2 px-6 rounded w-full mb-4 transition-colors hover:cursor-pointer ${
                isButtonDisabled
                  ? "opacity-50 cursor-not-allowed"
                  : "hover:bg-gray-900"
              }`}
            >
              {isButtonDisabled ? <Spinner /> : "ADD TO CART"}
            </button>
